      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="<?php echo base_url()."index.php/externos";?>">Buscar Folios <span class="sr-only"></span></a></li>
            <li><a href="<?php echo base_url()."index.php/externos2";?>">Listar Folios</a></li>
