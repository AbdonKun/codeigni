...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url()."index.php/";?>"><i class="fa fa-circle-o"></i> Board v1</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <!-- <li><a href="<?php echo base_url()."assets/";?>#"><i class="fa fa-circle-o"></i> Simple tables</a></li> -->
            <li><a href="<?php echo base_url()."index.php/";?>inicio"><i class="fa fa-circle-o"></i> Data tables</a></li>
          </ul>
        </li>


       <li class="header">LABELS</li>
        <li><a href="<?php echo base_url()."/";?>#"><i class="fa fa-circle-o text-red"></i> <span>Level1</span></a></li>
        <li><a href="<?php echo base_url()."/";?>#"><i class="fa fa-circle-o text-yellow"></i> <span>Level2</span></a></li>
        <li><a href="<?php echo base_url()."/";?>#"><i class="fa fa-circle-o text-aqua"></i> <span>Level3</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()."assets/";?>#">Tables</a></li>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Busqueda</h3>
                ...
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Factura</label>
  ...
  <footer class="main-footer">
    ...
    <strong><!-- Copyright &copy; 2014-2016 <a href="<?php echo base_url()."assets/";?>https://adminlte.io">Almsaeed Studio</a>. -->
